                ...
                <div className="out">
                  <span className="splash">
                    ...
                    <span className="default">
                      Enter above code into authenticator app of choice
                    </span>
                    <br />
                  </span>
                  <div className="suggested">
                    <span className="splash">
                      Suggested by Nonverse |{" "}
                      <a
                        href="https://steptwo.app/"
                        target="_blank"
                        rel="noreferrer"
                      >
                        Step Two
                  ...
                  <span className="splash">
                    2.{" "}
                    <span className="default">
                      Enter 6 digit code provided by app
                    </span>
                    <br />
                  </span>
                  <span className="splash">
                    3. <span className="default">Click Verify</span>
                  </span>
                </div>
                <button
              ...
              <div className="layout">
                ...
                <div className="out">
                  ...
                  <ul>
                    <li>
                      <span className="default">
                        Scan QR code using authenticator app of choice
                      </span>
                    </li>
                    <div className="suggested">
                      <span className="splash">
                    ...
                    <li>
                      <span className="default">Click Verify</span>
                    </li>
                  </ul>
                </div>
              </div>
